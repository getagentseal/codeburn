...
const bridge = {
  ...
  getModelsByAgent: (period: string, provider: string, range?: DateRange, background?: boolean) => invoke('codeburn:getModelsByAgent', period, provider, range, background),
  ...
  getWorkUnits: (period: string, provider: string, range?: DateRange, background?: boolean) => invoke('codeburn:getWorkUnits', period, provider, range, background),
