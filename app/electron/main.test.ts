...
const CHANNELS = [
  ...
  'codeburn:getModels',
  'codeburn:getModelsByAgent',
  'codeburn:getSessions',
  'codeburn:getWorkUnits',
...
const ARGV_CASES: Array<{ channel: string; args: unknown[]; argv: string[] }> = [
  ...
  { channel: 'codeburn:getWorkUnits', args: ['week', 'all'], argv: ['sessions', '--by-work-unit', '--format', 'json', '--period', 'week'] },
  { channel: 'codeburn:getWorkUnits', args: ['30days', 'claude', { from: '2026-07-01', to: '2026-07-11' }], argv: ['sessions', '--by-work-unit', '--format', 'json', '--period', '30days', '--provider', 'claude', '--from', '2026-07-01', '--to', '2026-07-11'] },
  { channel: 'codeburn:getModelsByAgent', args: ['week', 'all'], argv: ['models', '--by-agent', '--format', 'json', '--period', 'week'] },
  { channel: 'codeburn:getModelsByAgent', args: ['30days', 'claude', { from: '2026-07-01', to: '2026-07-11' }], argv: ['models', '--by-agent', '--format', 'json', '--period', '30days', '--provider', 'claude', '--from', '2026-07-01', '--to', '2026-07-11'] },
