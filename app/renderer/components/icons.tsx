...
/**
 * Lucide 1.46.0 (ISC) paths, inlined so the app carries no icon dependency.
 * Every glyph is drawn on the same 24 grid at stroke 1.75 in currentColor, so a
 * row of icons shares one optical weight whatever size the CSS gives it.
 */
const GLYPHS = {
  ...
  'credit-card': <><rect x="2" y="5" width="20" height="14" rx="2" /><line x1="2" x2="22" y1="10" y2="10" /><path d="M6 14h2" /></>,
