...
function looksLikeLocalModel(name: string): boolean {
  ...
  // (`anthropic.claude-haiku-4-5-20251001-v1:0`). That colon is a version, not
  // an Ollama tag: such a model is metered, and one with no price must reach
  // the unpriced list rather than be treated as free local inference.
